"""
Génère le livret de présentation Word (.docx) pour YARO
"""
...
body(doc, (
    ...
    "l'Honorable YARO Maquette, Garde des Sceaux, Ministre de la Justice "
    "et Site de démonstration — un outil de communication institutionnel, moderne et entièrement "
...
r = p11.add_run(
    ...
    "digne de la stature de Son Excellence YARO."
)
r.font.size = Pt(12)
r.font.color.rgb = NOIR
r.font.name = 'Calibri'
...
r1.font.name = 'Calibri'
r2 = pf2.add_run("Site officiel — YARO Maquette")
r2.bold = True
r2.font.size = Pt(13)
...
# ── Sauvegarde ────────────────────────────────────────────────────────────────
doc.save("Livret_Presentation_YARO.docx")
print("✅  Livret Word généré : Livret_Presentation_YARO.docx")
