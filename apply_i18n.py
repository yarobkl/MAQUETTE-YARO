...
patches = [
    ...
    # ── Hero eyebrow ticker ──────────────────────────────────────────────────
    (
        '<span>Maquette commerciale · YARO Agency &nbsp;·&nbsp; </span>',
        '<span data-i18n="hero.eyebrow">Maquette commerciale · YARO Agency &nbsp;·&nbsp; </span>',
    ),
    ...
    (
        '<div style="color:#fff;font-weight:700;font-size:16px;margin-bottom:6px">YARO devant le Conseil des droits de l\'homme — ONU</div>',
        '<div style="color:#fff;font-weight:700;font-size:16px;margin-bottom:6px" data-i18n="video.un.title">YARO devant le Conseil des droits de l\'homme — ONU</div>',
    ),
    (
...
NEW_KEYS_FR = {
    "hero.eyebrow": "Maquette commerciale · YARO Agency",
