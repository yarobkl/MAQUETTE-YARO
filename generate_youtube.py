#!/usr/bin/env python3
"""
Générateur de contenu YouTube pour la campagne YARO.
...
VIDEO_THEMES = [
    {
        "id": "presentation",
        "title": "Présentation — Qui est YARO ?",
        "type": "portrait",
    },
    {
        "id": "justice",
        "title": "Réforme de la Justice au Congo — Le bilan de YARO",
        "type": "bilan",
    },
    {
        "id": "ewo",
...
Contexte sur le député-ministre YARO :
{context}
