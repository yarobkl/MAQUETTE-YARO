"""
Génère la présentation PowerPoint (.pptx) pour YARO
"""
...
steps = [
    ("1", "Hébergement", "Mise en ligne sur un serveur officiel avec nom de domaine (ex: maquette-yaro.fr)"),
...
# ── Sauvegarde ────────────────────────────────────────────────────────────────
prs.save("Presentation_YARO.pptx")
print("✅  Présentation PowerPoint générée : Presentation_YARO.pptx")
