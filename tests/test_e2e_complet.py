"""
test_e2e_complet.py — Test end-to-end YARO
...
def run_all_tests():
    print("\n" + "=" * 65)
    print("  TEST END-TO-END COMPLET — SITE YARO")
    print("=" * 65)
...
if __name__ == "__main__":
    import os
    os.environ["YARO_TEST"] = "1"
    os.environ["YARO_FORCE_HTTP"] = "1"
    os.environ["YARO_PASS"] = "test123"
    ...
    httpd = _ThreadedHTTPServer(("127.0.0.1", PORT), srv.YaroHandler)
